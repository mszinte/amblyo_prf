...
# sh pycortex_maps_gridfit.sh /home/mszinte/disks/meso_H/projects amblyo_prf /home/mszinte/disks/meso_S/data
# -----------------------------------------------------------------------------------------
...
do
    ...
    python pycortex_maps_gridfit.py "$data_path" "$project_name" "$subject" n
done
